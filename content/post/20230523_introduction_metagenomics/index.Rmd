...
La metagenómica es una disciplina emergente que se centra en el análisis del material genético de las comunidades microbianas presentes en los ecosistemas naturales, esto es, en lugar de centrarse en un solo organismo, esta rama científica permite estudiar la diversidad y la función de las comunidades microbianas en su conjunto [@Handelsman2004]. Este enfoque permite el estudio de los microorganismos en su hábitat natural, sin la necesidad de cultivarlos en el laboratorio. Es así cómo la metagenómica ha revolucionado nuestra comprensión de la diversidad y la funcionalidad de las comunidades microbianas [@Wooley2010].
...
Una herramientas bioinformática muy importante que se utilizan en la metagenómica, es QIIME, que permite el análisis de datos de secuenciación de comunidades de alta densidad [@Caporaso2010]. Otras herramientas importantes incluyen MetaVelvet, que se utiliza para el ensamblaje de metagenomas, y Phyloseq, que proporciona una serie de herramientas para el análisis de datos de secuenciación de comunidades microbianas [@Quince2017].
